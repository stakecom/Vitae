...
public:
    CMainParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("0", "45.249.244.140")); // Primary DNS seeder
        vSeeds.push_back(CDNSSeedData("1", "152.32.169.75")); // Secondar DNS seeder
        vSeeds.push_back(CDNSSeedData("2", "47.75.14.207")); // Secondar DNS seeder
        ...
        strSporkKey = "040d2375653a3064623b8a9e179c34a4ffa9ee9afbc13e2218b37f5fa6cbe2f94ef874a216cbfddbcbf06b5951a9011d65dae988fb4469fabcfa29b9c8daf23c7e";
